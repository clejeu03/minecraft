...
namespace minecraft {
	...
	class Cube : public Drawable {
		...
		public:
			...
			int GetBreakable(){return m_breakable;};
	...
	class SkyBoxCube : public Cube {
		public:
			...
			SkyBoxCube(){m_breakable=1;m_name = "SkyBoxCube"; m_type = SKYBOX_CUBE; }
	...
	class FloatingCube : public Cube {
		public:
			FloatingCube(){ m_breakable=1;m_name = "FloatingCube"; m_type = FLOATING_CUBE; }
	};

	/* Affected by gravity */
	class PhysicCube : public Cube {
		public:
			PhysicCube(){ m_breakable=1;m_name = "PhysicCube"; m_type = PHYSIC_CUBE; }
	};

	class CloudCube : public FloatingCube {
		public:
			CloudCube(){m_breakable=1;m_name="CloudCube"; m_type = CLOUD_CUBE; };
	};

	class RockCube : public PhysicCube {
		public:
			RockCube(){m_breakable=1;m_name="RockCube"; m_type = ROCK_CUBE; };
	};

	class CrystalCube : public PhysicCube {
		public:
			CrystalCube(){ m_breakable=1;m_name = "CrystalCube"; m_type = CRYSTAL_CUBE; }
	};

	class DirtCube : public PhysicCube {
		public:
			DirtCube(){m_breakable=1; m_name = "DirtCube"; m_type = DIRT_CUBE; }
	};

	class GoldCube : public PhysicCube {
		public:
			GoldCube(){m_breakable=1; m_name = "GoldCube"; m_type = GOLD_CUBE; }
	};

	class DiamondCube : public PhysicCube {
		public:
			DiamondCube(){m_breakable=0; m_name = "DiamondCube"; m_type = DIAMOND_CUBE; }
	};

	class GrassCube : public PhysicCube {
		public:
			GrassCube(){m_breakable=1; m_name = "GrassCube"; m_type = GRASS_CUBE; }
	};
